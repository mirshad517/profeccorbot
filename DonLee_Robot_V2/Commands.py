...
async def about(bot: DonLee_Robot_V2, msg: Import.Msg):
        button = [[
          Import.Button("👨‍💻Code", url='https://github.com/mirshad517/source-code/blob/main/README.md'),
...
async def sub(bot: DonLee_Robot_V2, msg: Import.Msg):
        button = [[     
          Import.Button("Code👨‍💻", url="https://github.com/mirshad517/source-code/blob/main/README.md"),
          Import.Button("𝖲𝗎𝗉𝗉𝗈𝗋𝗍🤝", url="https://github.com/mirshad517/source-code/blob/main/README.md")
          ],[
          Import.Button("📢𝖴𝗉𝖽𝖺𝗍𝖾𝗌", url="https://t.me/botupdat"),
          Import.Button("Channel💞", url="https://t.me/kvr_movies_group")
          ],[
          Import.Button("📦𝖦𝗂𝗍𝗁𝗎𝖻", url="https://github.com/mirshad517/source-code/blob/main/README.md"),
          Import.Button("𝖨𝗇𝗌𝗍𝖺😁", url="https://t.me/Mirshad_photo_editor_bot")
          ],[
          Import.Button("𝖢𝗅𝗈𝗌𝖾🗑️", callback_data="close")
          ]]                     
        await bot.send_photo(
...
async def admin(bot, msg):
    button = [[  
       Import.Button("𝖢𝗅𝗂𝖼𝗄 𝖧𝖾𝗋𝖾➡️", url="t.me/dev_mirshad")
       ]]
    await msg.reply_text(
